import '/affichage/components/pause_card/pause_card_widget.dart';
                  ...
                  children: [
                    StreamBuilder<List<BudgetsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<BudgetsRecord> cardDynamicBudgetsRecordList =
                            snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final cardDynamicBudgetsRecord =
                            cardDynamicBudgetsRecordList.isNotEmpty
                                ? cardDynamicBudgetsRecordList.first
                                : null;
                        return Container(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        cardDynamicBudgetsRecord?.budgetAmount,
                                        'montant',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .displaySmall
